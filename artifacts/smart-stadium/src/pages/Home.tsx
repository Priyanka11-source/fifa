...
function SectionWrapper({
  ...
  return (
    <section
      id={id}
      className="w-full max-w-7xl mx-auto px-6 py-5 relative z-10 scroll-mt-24"
    >
      <div
        className={`glass-panel p-6 md:p-8 rounded-sm border-t-2 ${borderColor} ${shadowClass} ${hoverClass} transition-all duration-500`}
      >
        {(label || title) && (
          <div className="mb-6">
            {label && (
              <div className="flex items-center gap-2 mb-1">
                ...
                <span
                  className={`text-[10px] font-mono uppercase tracking-[0.2em] font-semibold opacity-80`}
                >
                  {label}
                </span>
              </div>
...
export default function Home() {
  ...
  return (
    <main className={mainClasses} role="main" id="main-content">
      ...
      <div
        aria-hidden="true"
        className="absolute top-[5%] left-[5%] w-[400px] h-[400px] rounded-full bg-neon-cyan/15 pointer-events-none filter blur-[100px] z-0 animate-pulse"
        style={{ animationDuration: "8s" }}
      />
      <div
        aria-hidden="true"
        className="absolute top-[25%] right-[5%] w-[500px] h-[500px] rounded-full bg-neon-purple/15 pointer-events-none filter blur-[130px] z-0 animate-pulse"
        style={{ animationDuration: "12s" }}
      />
      <div
        aria-hidden="true"
        className="absolute top-[55%] left-[12%] w-[450px] h-[450px] rounded-full bg-neon-pink/12 pointer-events-none filter blur-[110px] z-0 animate-pulse"
        style={{ animationDuration: "10s" }}
      />
      <div
        aria-hidden="true"
        className="absolute top-[80%] right-[10%] w-[550px] h-[550px] rounded-full bg-neon-orange/12 pointer-events-none filter blur-[140px] z-0 animate-pulse"
        style={{ animationDuration: "14s" }}
      />

      {/* Global Glowing Navigation Bar */}
      <header
        className="sticky top-0 z-50 w-full bg-[#0a0818]/90 backdrop-blur-md relative overflow-hidden shadow-[0_4px_25px_rgba(0,0,0,0.6)]"
        role="banner"
      >
          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              >
                ...
                <path
                  d="M 0 0 L 20 11.54 L 40 0 M 20 11.54 L 20 34.64 L 0 46.18 M 20 34.64 L 40 46.18 M 0 46.18 L 20 57.73 L 40 46.18 M 20 57.73 L 20 69.28"
                  fill="none"
                ...
                <polygon
                  points="20,23.09 30,28.86 30,40.41 20,46.18 10,40.41 10,28.86"
                  fill="rgba(0,0,0,0.8)"
                ...
                <polygon
                  points="0,0 20,11.54 20,23.09 0,11.54"
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-mono text-[9px] text-primary uppercase tracking-[0.25em] font-medium">
                FIFA 2026 World Cup
              </span>
              <span className="font-serif text-sm tracking-wide text-foreground font-semibold text-gold-glow">
                SMART STADIUM
              </span>
            </div>
          </div>
          ...
          <nav
            aria-label="Portal mode navigation"
            className="flex items-center bg-black/50 border border-primary/10 p-1 rounded-sm gap-1"
            role="tablist"
          >
            <button
        ...
        >
          ...
          <Hero
            onDeployCommand={() => {
              ...
              setTimeout(() => {
                document
                  .getElementById("command-center-section")
                  ?.scrollIntoView({ behavior: "smooth" });
              }, 100);
            }}
            onViewDirectives={() => {
              document
                .getElementById("stadium-map-section")
                ?.scrollIntoView({ behavior: "smooth" });
            }}
          />
      ...
      {/* Footer */}
      <footer
        className="w-full py-16 border-t border-primary/20 bg-[#020403] text-center relative z-10"
        role="contentinfo"
      >
