...
const TranslationIcon = () => (
  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-primary drop-shadow-[0_0_8px_rgba(212,175,55,0.35)]">
    {/* Globe base and grid */}
    ...
    <path d="M12 3C14.5 5.5 15.5 8.5 15.5 12C15.5 15.5 14.5 18.5 12 21C9.5 18.5 8.5 15.5 8.5 12C8.5 8.5 9.5 5.5 12 3Z" stroke="currentColor" strokeWidth="1.2" />
    {/* Classic Soccer Ball seam panel outlines inside globe to represent soccer ball to globe morph */}
    <path d="M8.5 6.5L6.5 8.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    <path d="M15.5 6.5L17.5 8.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    <path d="M8.5 17.5L6.5 15.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    <path d="M15.5 17.5L17.5 15.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    {/* Tiny football pentagon patch center */}
    <path d="M12 9.5L14 11L13 13.5H11L10 11L12 9.5Z" fill="currentColor" fillOpacity="0.25" stroke="currentColor" strokeWidth="1.2" />
  </svg>
);
...
const TicketIcon = () => (
  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-primary drop-shadow-[0_0_8px_rgba(212,175,55,0.35)]">
    {/* Ticket stub base */}
    <path d="M2 7C2 5.89543 2.89543 5 4 5H20C21.1046 5 22 5.89543 22 7V9.5C20.6193 9.5 19.5 10.6193 19.5 12C19.5 13.3807 20.6193 14.5 22 14.5V17C22 18.1046 21.1046 19 20 19H4C2.89543 19 2 18.1046 2 17V14.5C3.38071 14.5 4.5 13.3807 4.5 12C4.5 10.6193 3.38071 9.5 2 9.5V7Z" stroke="currentColor" strokeWidth="1.2" fill="currentColor" fillOpacity="0.05" />
    {/* Ticket tear line */}
    <line x1="7.5" y1="5" x2="7.5" y2="19" stroke="currentColor" strokeWidth="1" strokeDasharray="2 2" />
    {/* Floating glowing QR code emitting from stub */}
    <g transform="translate(11, 8.5) scale(0.65)" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square">
      {/* QR Code markers */}
      <rect x="0" y="0" width="3" height="3" fill="currentColor" strokeWidth="1" />
      <rect x="6" y="0" width="3" height="3" fill="currentColor" strokeWidth="1" />
      <rect x="0" y="6" width="3" height="3" fill="currentColor" strokeWidth="1" />
    ...
    <path d="M12 8L10 6M15 8L17 6M11 15L9 17M16 15L18 17" stroke="currentColor" strokeWidth="0.8" opacity="0.6" strokeLinecap="round" />
  </svg>
);
...
function InteractiveCard({ children, className = "" }: { children: React.ReactNode, className?: string }) {
  ...
  const rotateX = isHovered ? (coords.y - (cardRef.current?.clientHeight || 0) / 2) / 10 : 0;
  const rotateY = isHovered ? -((coords.x - (cardRef.current?.clientWidth || 0) / 2) / 10) : 0;
                  ...
                  <motion.div
                    ...
                    onClick={() => {
                      toast({
                        ...
                        description: "Matchday Ticket SEC 104 is active. Accessible paths to Gate 12 accessibility loop are clear.",
                      });
                    }}
