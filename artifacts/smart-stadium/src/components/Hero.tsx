    ...
    <div className="relative w-full h-[100dvh] overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0,0,0,0.1) 0%, rgba(10,5,0,0.45) 60%, rgba(5,5,5,0.92) 100%)",
          }}
        />
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
        <div className="flex flex-col items-center">
          ...
          >
            The 2026 World Cup demands more than concrete and steel. Experience
            the GenAI Smart Stadium — where operations meet intuition, and every
            fan feels the heartbeat of the game.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3 relative z-10 font-bold">
                ...
                <span className="text-[#F3EFE7] group-hover:text-primary transition-colors">
                  Initialize Stadium GenAI
                </span>
              </div>
